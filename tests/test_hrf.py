...
class TestSPMHRFModel:
    ...
    def test_hrf_length(self, hrf_model):
        ...
        hrf = ops.convert_to_numpy(hrf_model.get_hrf())
    ...
    def test_custom_delay_shifts_peak(self, hrf_model):
        ...
        hrf_early = ops.convert_to_numpy(hrf_model.get_hrf(hrf_delay=4.))
        hrf_late = ops.convert_to_numpy(hrf_model.get_hrf(hrf_delay=7.))
...
class TestSpmHrfFunction:
    ...
    def test_output_shape(self):
        ...
        hrf = ops.convert_to_numpy(spm_hrf(t))
